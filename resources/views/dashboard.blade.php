                    ...
                    <div class="flex items-center justify-between gap-4 py-2 border-b last:border-0 text-sm">
                        ...
                        <div class="flex items-center gap-3 shrink-0">
                            ...
                            <button type="button"
                                    ...
                                    class="inline-flex items-center justify-center h-8 w-8 rounded-md text-gray-400 hover:text-red-600 hover:bg-red-50 focus:outline-none focus:ring-2 focus:ring-red-500">
